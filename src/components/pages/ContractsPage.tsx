...
import NewContractModal from '../ui/NewContractModal'
...
export default function ContractsPage() {
  ...
  const { contracts, loading, error, addContract } = useContracts()
  ...
  const handleCreateContract = async (contractData: Omit<ContractListItem, 'id'>) => {
    try {
      // Add the contract using the hook method
      const newContract = await addContract(contractData)
      
      // Show success message
      toast.success(`Contract "${contractData.name}" created successfully!`)
