                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div >
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-3 bg-[#27283f] border rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all ${errors.name ? 'border-red-500' : 'border-[#2a2d47]'
                                    }`}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-3 bg-[#27283f] border rounded-xl text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all ${errors.parties ? 'border-red-500' : 'border-[#2a2d47]'
                                    }`}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-3 bg-[#27283f] border rounded-xl text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all ${errors.expiry ? 'border-red-500' : 'border-[#2a2d47]'
                                    }`}
                            />
                            {errors.expiry && (
                        ...
                        {/* Form Actions */}
                        <div className="flex items-center justify-center space-x-4 pt-6 border-t border-[#2a2d47]">
                            <button
                                type="submit"
